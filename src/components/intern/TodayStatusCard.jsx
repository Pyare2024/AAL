  ...
  return (
    <section className="bg-white border border-[#EDEDED] rounded-2xl p-5 sm:p-6 shadow-sm space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        {/* Pending Work Count */}
        <div className={`p-4 border rounded-xl flex flex-col justify-between space-y-2 transition-all ${pendingWorkCount > 0 ? 'bg-orange-50/60 border-orange-200' : 'bg-emerald-50/60 border-emerald-200'
          }`}>
        ...
        {/* Today's To-do Count */}
        <div className={`p-4 border rounded-xl flex flex-col justify-between space-y-2 transition-all ${todayTodoCount > 0 ? 'bg-orange-50/60 border-orange-200' : 'bg-emerald-50/60 border-emerald-200'
          }`}>
