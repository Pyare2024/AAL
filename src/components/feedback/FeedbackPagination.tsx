...
export const FeedbackPagination: React.FC<Props> = ({ currentPage, totalPages, totalCount, onPageChange }) => {
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-gray-700">
            Showing <span className="font-medium">{totalCount === 0 ? 0 : (currentPage - 1) * 20 + 1}</span> to{' '}
