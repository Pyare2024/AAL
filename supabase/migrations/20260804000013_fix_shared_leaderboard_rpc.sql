-- ==============================================================================
-- FIX SHARED LEADERBOARD RPCs
-- Adds explicit SET search_path = public to SECURITY DEFINER
-- Revokes PUBLIC execute and Grants authenticated
-- Ensures full eligible dataset is built before any viewer filtering
-- ==============================================================================
...
REVOKE ALL ON FUNCTION public.get_leaderboard_filter_options() FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_leaderboard_filter_options() TO authenticated;


-- 2. Main Shared Leaderboard RPC
...
REVOKE ALL ON FUNCTION public.get_leaderboard(TEXT, TEXT, TEXT, INT, INT, TEXT, TEXT) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_leaderboard(TEXT, TEXT, TEXT, INT, INT, TEXT, TEXT) TO authenticated;
