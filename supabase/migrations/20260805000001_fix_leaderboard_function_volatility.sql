...
BEGIN
  ...
  -- Explicitly drop temp tables to ensure cleanliness in pooler
  DROP TABLE IF EXISTS temp_filtered_interns;
  DROP TABLE IF EXISTS temp_ranked_interns;
