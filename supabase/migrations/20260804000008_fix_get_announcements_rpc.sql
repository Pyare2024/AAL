-- ==============================================================================
-- FIX AMBIGUOUS GET ANNOUNCEMENTS RPC
-- ==============================================================================

-- Drop all overloads of get_announcements to remove ambiguity
DROP FUNCTION IF EXISTS public.get_announcements(TEXT, TEXT, TEXT, TEXT, BOOLEAN, TEXT, TEXT, TEXT, INTEGER, INTEGER, TEXT, TEXT);
DROP FUNCTION IF EXISTS public.get_announcements(TEXT, TEXT, TEXT, TEXT, BOOLEAN, UUID, DATE, DATE, INT, INT, TEXT, TEXT);

-- Recreate a single, canonical get_announcements function matching the frontend
...
BEGIN
  ...
  -- CTE to find accessible announcements first
...
REVOKE ALL ON FUNCTION public.get_announcements(TEXT, TEXT, TEXT, TEXT, BOOLEAN, UUID, TIMESTAMPTZ, TIMESTAMPTZ, INT, INT, TEXT, TEXT) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_announcements(TEXT, TEXT, TEXT, TEXT, BOOLEAN, UUID, TIMESTAMPTZ, TIMESTAMPTZ, INT, INT, TEXT, TEXT) TO authenticated;
