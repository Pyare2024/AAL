-- ==============================================================================
-- MIGRATION: Secure Feedback Status Management
-- Description: Implements strict role-aware status transitions via RPC 
--              to prevent arbitrary data modification and silent RLS failures.
-- ==============================================================================

-- Create secure RPC for updating ticket status
...
BEGIN
  ...
  -- Interns generally shouldn't change status directly in this system unless 
  -- re-opening a resolved ticket (not requested right now, so blocked).
...
REVOKE ALL ON FUNCTION public.update_feedback_status FROM PUBLIC;
